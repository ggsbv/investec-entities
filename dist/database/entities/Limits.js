...
var Limit = /** @class */ (function () {
    ...
    __decorate([
        typeorm_1.Column("text"),
        __metadata("design:type", String)
    ], Limit.prototype, "riskType", void 0);
    __decorate([
        typeorm_1.Column("text"),
        __metadata("design:type", String)
    ], Limit.prototype, "currency", void 0);
    __decorate([
        typeorm_1.Column({ type: "float", precision: 13, scale: 2 }),
        __metadata("design:type", Number)
    ], Limit.prototype, "exposureAmount", void 0);
    __decorate([
        typeorm_1.Column("varchar"),
        __metadata("design:type", Number)
    ], Limit.prototype, "totalCurrentLimit", void 0);
    __decorate([
        typeorm_1.Column("varchar"),
        __metadata("design:type", Number)
    ], Limit.prototype, "totalApprovedLimit", void 0);
    __decorate([
